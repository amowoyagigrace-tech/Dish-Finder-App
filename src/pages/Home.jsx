    ...
    <div className="px-5 py-6 max-w-lg mx-auto">
      ...
      <div className="bg-card border border-border rounded-2xl p-4 mb-6">
        ...
        <p className="text-muted-foreground text-sm mb-4">
          {tier === "free" ? `Searches remaining: ${searchesLeft}` : "Unlimited searches"}
        </p>
        {tier === "free" && (
      ...
      <div className="space-y-0 rounded-2xl border border-border overflow-hidden">
        <Link to="/search" className="flex items-center gap-3 bg-card px-4 py-4 border-b border-border hover:bg-muted transition-colors">
        ...
        <Link to="/favourites" className="flex items-center gap-3 bg-card px-4 py-4 hover:bg-muted transition-colors">
